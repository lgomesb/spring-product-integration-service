...
public class ProductIntegrationServiceAspect {
    ...
    @Before("execution(* com.barbosa.ms.productintegrationservice.productintegrationservice.services.*.* (..))")
    ...
    @AfterReturning(pointcut = "execution(* com.barbosa.ms.productintegrationservice.productintegrationservice.services.*.* (..))", returning = "result")
