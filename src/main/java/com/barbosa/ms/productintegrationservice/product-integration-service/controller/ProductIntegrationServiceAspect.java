...
@Aspect
@Component
public class ProductIntegrationServiceAspect {
    
        private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Before("execution(* com.barbosa.ms.productintegrationservice.product-integration-service.services.*.* (..))")
    ...
    @AfterReturning(pointcut = "execution(* com.barbosa.ms.productintegrationservice.product-integration-service.services.*.* (..))", returning = "result")
